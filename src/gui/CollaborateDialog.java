...
public class CollaborateDialog extends JDialog {
    ...
    public CollaborateDialog ( Frame parent, Client model ) {
        ...
        _serverURLField = new JTextField("localhost");
        ...
        _serverPortField = new JTextField("1099");
        ...
        _documentNameField = new JTextField("DefaultDoc");
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if (errorMessage.length() > 0) { popUpMessage(errorMessage); }
                    ...
                    try {
                        ...
                        _client.initiateCollaboration(_serverURLField.getText() + ":" + _serverPortField.getText());
                    }
