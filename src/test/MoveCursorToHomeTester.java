...
public class MoveCursorToHomeTester extends TestCase {
    ...
    public static void main(String[] args) {
        MoveCursorToHomeTester test = new MoveCursorToHomeTester();
        test.setUp();
        test.test0();
        test.setUp();
        test.test1();
    ...
    private void moveCursorThenTest(int position){
        try{
            ...
            MoveCursorToHome command0 = new MoveCursorToHome(_user0);
    ...
    //Set position 0. Go to Home.
    public void test0(){
        moveCursorThenTest(0);
    }
    
    //Set position to 1. Go to Home.
    public void test1(){
        moveCursorThenTest(1);
    }
    
    //Set position to 2. Go to Home.
    public void test2(){
        moveCursorThenTest(2);
    }
    
    //Set position to 3. Go to Home.
    public void test3(){
        moveCursorThenTest(3);
    }
    
    //Set position to 4. Go to Home.
    public void test4(){
        moveCursorThenTest(4);
    }
    
    //Set position to 5. Go to Home.
    public void test5(){
        moveCursorThenTest(5);
    }
    
    //Set position to 6. Go to Home.
    public void test6(){
